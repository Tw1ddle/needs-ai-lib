...
**/
class ActionSet<ActionSetIdType, ActionIdType, ConsiderationIdType> {
	/**
	   Id for this action set.
	**/
	public var id(default, null):ActionSetIdType;
	...
	**/
	public var actions(default, null):Array<Action<ActionIdType, ConsiderationIdType>>;
	...
	**/
	public function new(id:ActionSetIdType, name:String, actions:Array<Action<ActionIdType, ConsiderationIdType>>) {
		this.id = id;
		this.name = name;
